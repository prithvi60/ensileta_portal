...
const ForgotPassword = () => {
    ...
    return (
        <div
            className={`rounded-md border-4 border-secondary w-full max-w-3xl mx-auto bg-white shadow-xl m-4 p-3 md:p-6 ${isSubmitted ? "max-w-lg" : "max-w-3xl"
                }`}
        >
            ...
            {isSubmitted ? (
                <div>
                    <h2 className="text-xl mt-8 animate-pulse font-bold text-warning tracking-wider text-center">
                        The email has been sent successfully. Check your inbox now for the
                        message!.
                    </h2>
                </div>
            ) : (
