            ...
            <div className="flex flex-wrap items-center">
                ...
                <div className="w-full p-4 sm:px-6 sm:py-0 xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5 text-[#0E132A]">
                        ...
                        <h2 className="mb-3 text-lg font-bold text-[#0E132A] md:text-2xl">
                            Sign Up to Ensileta Portal
                        </h2>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='space-y-2' >
                            <div className=''>
                                ...
                                {errors.username && (
                                    <div className="text-[#C72422] font-semibold text-center text-sm mt-1">{errors.username.message}</div>
                                )}
                            </div>
                            <div>
                                <div className='flex gap-3 items-center'>
                                ...
                                {errors.email && (
                                    <div className="text-[#C72422] font-semibold text-center text-sm mt-1">{errors.email.message}</div>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {errors.password && (
                                    <div className="text-[#C72422] font-semibold text-center text-sm mt-1">{errors.password.message}</div>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {errors.confirmPassword && (
                                    <div className="text-[#C72422] font-semibold text-center text-sm mt-1">{errors.confirmPassword.message}</div>
                                )}
                            </div>
                            ...
                            <div className="mt-6 text-center">
                                <p>
                                    ...
                                    <Link href="/api/auth/signin" className="text-[#139F9B]">
                                        Sign in
                                    </Link>
                                </p>
                            </div>
