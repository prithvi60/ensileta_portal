        ...
        <div className="rounded-md border-4 border-[#139F9B] bg-white shadow-xl m-4" >
            <div className="flex flex-wrap items-center">
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="p-4 sm:px-12 sm:py-4 space-y-5 text-center">
                        <div className='mb-10'>
                ...
                <div className="w-full p-4 sm:px-12 sm:py-4 xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5 text-[#0E132A]">
                        ...
                        <form className='space-y-2' onSubmit={handleSubmit}>
                            <div className="">
                                <label className="mb-1.5 md:mb-2.5 block font-medium text-[#0E132A] text-sm md:text-base">
                                    Name
                                </label>
