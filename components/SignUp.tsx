                    ...
                    <div className="w-full p-4 sm:p-12.5 xl:p-17.5 text-[#0E132A]">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='space-y-2' >
                            <div className=''>
                                ...
                                {errors.username && (
                                    <div className="text-[#C72422] text-sm mt-1">{errors.username.message}</div>
                                )}
                            </div>
                            <div>
                                <div className='flex gap-3 items-center'>
                                ...
                                {errors.email && (
                                    <div className="text-[#C72422] text-sm mt-1">{errors.email.message}</div>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {errors.password && (
                                    <div className="text-[#C72422] text-sm mt-1">{errors.password.message}</div>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {errors.confirmPassword && (
                                    <div className="text-[#C72422] text-sm mt-1">{errors.confirmPassword.message}</div>
                                )}
                            </div>
